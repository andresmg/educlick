        ...
        <?php if( have_rows('buttons') ): ?>
            ...
            <div class="col-12 col-sm-5">
              <a
                ...
                class="Main__Pds__cards <?php if ($delay == 0) { echo "mt-5"; } ?>"
                data-aos="fade-up"
                data-aos-once="true"
                data-aos-duration="800"
                data-aos-delay="<?php echo $delay ?>"
              >
                <div class="icons icons__book" style="background: #70D5F8 url(<?php echo $button_icon['url'] ?>) no-repeat center / 12rem;"></div>
