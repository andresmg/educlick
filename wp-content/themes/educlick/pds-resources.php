      ...
      <div class="Main__Resources">
        <div class="row">
          <div class="col-12 col-sm-6">
            <div class="row">
              <div class="col-sm-6 col-12 Main__Resources__column" style="
              ...
              <div class="col-sm-4 col-12">
                ...
                <?php if( have_rows('buttons') ): ?>
                  <?php $count = 1; while( have_rows('buttons') ): the_row(); 
                    ...
                    ?>
                    <div
                      class="col-sm-12 col-6 button <?php if ($count == 1) { echo "active topbtn"; } ?><?php if ($count > 1) { echo "bttmbtn"; } ?> light"
          ...
          <div class="col-12 col-sm-4 Main__Resources__info">
            ...
            <div id="<?php if ($count == 1) { echo "top"; } ?><?php if ($count > 1) { echo "bottom"; } ?>" class="<?php if ($count == 1) { echo "d-block"; } ?> <?php if ($count > 1) { echo "d-none"; } ?>">  
              ...
              >
                ...
                <h1 class="title light <?php if ($count == 1) { echo "student"; } ?> <?php if ($count > 1) { echo "teacher"; } ?>"><?php echo $content_title ?></h1>
